...
The output goes to `simulations/<case>/`. Each generated folder contains the
initial bulk data, bulk and film inputs, separate Slurm scripts, and a pair
submission script. To queue both stages, enter the case folder and run
...
`--chains 40 --output simulations/data.pilot_pdms` before submitting the full
